...
namespace OnlyFive
{
    ...
    public class IdentityServerResourceOwnerPasswordValidator<TUser> : IResourceOwnerPasswordValidator
            where TUser : IdentityUser
    {
            ...
            public IdentityServerResourceOwnerPasswordValidator(
            ...
            {
                var user = context.UserName == "email_grant" ?
                await _userManager.FindByEmailAsync(context.Request.Raw.Get("email")) :
