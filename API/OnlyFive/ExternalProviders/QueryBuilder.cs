...
namespace OnlyFive.ExternalProviders
{
    public static class QueryBuilder
    {
        ...
        public static string GetQuery(Dictionary<string, string> values, ExtrenalProviderEnum provider)
        {
            switch (provider)
            {
                case ExtrenalProviderEnum.Facebook:
                ...
                case ExtrenalProviderEnum.Twitter:
                    try
                    {
                ...
                case ExtrenalProviderEnum.Google:

                    var google_access_token = values["token"];
                    return $"?id_token={google_access_token}";
