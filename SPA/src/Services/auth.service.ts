...
import { JwtHelper } from 'src/Utilities/jwt-helper';
import { AccessToken } from 'src/Types/access-token';
import { PermissionValues } from 'src/Types/permission';
import { DBkeys } from 'src/Utilities/db-keys';
import { AuthOpenIdProviders } from './auth.openId.provider';
...
export class AuthService {
  ...
  private preLogin(rememberMe: boolean){
    if (this.isLoggedIn) {
      this.logout();
    }
